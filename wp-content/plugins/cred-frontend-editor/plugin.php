...
/*cred_log($_SERVER['DOCUMENT_ROOT']);
cred_log(CRED_Loader::getDocRoot());
cred_log(CRED_Loader::getBaseUrl());
cred_log(CRED_PLUGIN_URL);*/
/*cred_log(CRED_Loader::getUSymlink(
    '/~user/import/wp-content/plugins/cred-frontend-editor/plugin.php', 
    '/home/user/public_html/import/wp-content/plugins/cred-frontend-editor/plugin.php'
));*/
...
CRED_Loader::add('assets', array(
    'SCRIPT'=>array(
        ...
        'cred_codemirror_dev'=>array(
            ...
            'version'=>CRED_FE_VERSION,
            'dependencies'=>null,
            'path'=>CRED_ASSETS_URL.'/third-party/codemirror311.js',
            'src'=>CRED_ASSETS_PATH.'/third-party/codemirror311.js'
        ),
        'cred_codemirror'=>array(
            ...
            'version'=>CRED_FE_VERSION,
            'dependencies'=>null,
            'path'=>CRED_ASSETS_URL.'/third-party/codemirror311.min.js',
            'src'=>CRED_ASSETS_PATH.'/third-party/codemirror311.min.js'
        ),
    ...
    'STYLE'=>array(
        ...
        'cred_template_style'=>array(
            ...
            'loader_path'=>CRED_FILE_PATH,
            'version'=>CRED_FE_VERSION,
            'dependencies'=>array('wp-admin', 'colors-fresh', 'font-awesome', 'cred_cred_style_nocodemirror'),
        ...
        'cred_codemirror_style_dev'=>array(
            ...
            'version'=>CRED_FE_VERSION,
            'dependencies'=>null,
            'path'=>CRED_ASSETS_URL.'/third-party/codemirror311.css',
            'src'=>CRED_ASSETS_PATH.'/third-party/codemirror311.css'
        ),
        'cred_codemirror_style'=>array(
            ...
            'version'=>CRED_FE_VERSION,
            'dependencies'=>null,
            'path'=>CRED_ASSETS_URL.'/third-party/codemirror311.min.css',
            'src'=>CRED_ASSETS_PATH.'/third-party/codemirror311.min.css'
        ),
        'font-awesome'=>array(
            'loader_url'=>CRED_FILE_URL,
            'loader_path'=>CRED_FILE_PATH,
        ...
        'cred_cred_style_dev'=>array(
            ...
            'loader_path'=>CRED_FILE_PATH,
            'version'=>CRED_FE_VERSION,
            'dependencies'=>array('font-awesome', 'cred_codemirror_style_dev', 'wp-jquery-ui-dialog', 'wp-pointer'),
        ...
        'cred_cred_style'=>array(
            ...
            'loader_path'=>CRED_FILE_PATH,
            'version'=>CRED_FE_VERSION,
            'dependencies'=>array('font-awesome', 'cred_codemirror_style', 'wp-jquery-ui-dialog', 'wp-pointer'),
...
// init loader for this specific plugin
...
{
    $output=CRED_Helper::cred_delete_post_link($post_id, $text, $action, $class, $style);
    if ($return)
        return $output;
    echo $output;
}
