        ...
        makeAreaResizable : function($textarea)
        {
            ...
            (function() {
                ...
                var resizeCodemirror=function()
                {
                    if (CodeMirrorEditors[id])
                    {
                        CodeMirrorEditors[id].setSize(null, $textarea.height())
                    }
                };
    ...
    var self = {
        ...
        getFormFields : function($area)
        {
            ...
            var content=utils.getContent($area).replace(/[\n\r]+/g, ' '), // normalize, remove \n
                ...
                patterns = [
                    // custom fields
                    {rx: /\[cred\-field\b[^\[\]]*field=[\"\']([\d\w\-_]+)[\"\'][^\[\]]*?\]/g, field: 1, type: false, generic: false},
                    // custom fields variation 2
                    {rx: /\[cred_field\b[^\[\]]*field=[\"\']([\d\w\-_]+)[\"\'][^\[\]]*?\]/g, field: 1, type: false, generic: false}, 
                ...
                init: function() {
                    ...
                    view
                        ...
                        .action('validateSection', function($el, data){
                            if (data && undefined!==data.validationResult)
                                    ...
                                    if (window.tinyMCEPreInit)
                                    {
                                        ...
                                        */
                                        ...
                                        if (typeof(window.tinymce) == 'object' && window.tinyMCEPreInit.mceInit['credmailbody__i__'])
                                        {
                                            ...
                                            {
                                                window.tinyMCEPreInit.mceInit[newId]=tinymce.extend( {}, window.tinyMCEPreInit.mceInit['credmailbody__i__'] );
                                                ...
                                                var DOM = window.tinymce.DOM, el=newId;
                                                DOM.events.add( DOM.select('#wp-'+el+'-wrap'), 'mousedown', function(e){
                                                    if ( this.id )
                                                        window.wpActiveEditor = this.id.slice(3, -5);
                                                });
                                                
                                                // init tinymce on new dynamic area
                                                try { window.tinymce.init( window.tinyMCEPreInit.mceInit[newId] ); } catch(e){}
                                            }
                                        }
                                        if ( window.tinyMCEPreInit.qtInit && window.tinyMCEPreInit.qtInit['credmailbody__i__'] ) 
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (typeof(window.tinymce) != 'object')
                                                {
                                                    ...
                                                    document.getElementById('wp-'+el+'-wrap').onmousedown = function(){ window.wpActiveEditor = this.id.slice(3, -5); }
                                                }
                                                ...
                                                if ( typeof(window.QTags) == 'function' ) 
                                                {
                                                   ...
                                                   try { 
                                                    ...
                                                    window.QTags.instances[newId] = ed;
                                                    //window.wpActiveEditor = newId;
                                                    $('#'+newId+'-tmce').trigger('click');
                    ...
                    function validateView()
                    {
                        ...
                        view.getElements('.cred_validation_section').each(function(){
                            ...
                            {
                                view.isValid=false;
                                $this.find('.cred-notification.cred-error.cred-section-validation-message').show();
                            }
                            else
                            {
                                $this.find('.cred-notification.cred-error.cred-section-validation-message').hide();
                            }
                        });                    
                    }
