 ...
 **/
    ...
    public function cred_generic_field_shortcodes($atts, $content='')
    {
        ...
        if ($atts['type']=='image' || $atts['type']=='file')
        {
            ...
            $ids=$formHelper->translate_field($name, $field, array('preset_value'=>$default, 'urlparam'=>$atts['urlparam']));
 ...
 **/
    ...
    */
    ...
    private function addFriendStatic($fr, array $shared=array())
    {
    ...
    // use these "magic" methods to share with friends
    public function _setStatic_($prop, $val)
    {
    ...
    // use these "magic" methods to share with friends
    public function &_getStatic_($prop)
    {
