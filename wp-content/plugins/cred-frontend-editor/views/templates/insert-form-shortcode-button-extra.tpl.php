...
<span class="cred-media-button cred-form-shortcode-button2">
    ...
    <div class="cred-popup-box cred-form-shortcodes-box2 stuffbox">
		...
		<p class="cred-buttons-holder">
			...
			<a data-content="<?php echo $content; ?>" disabled='disabled' class="cred-insert-shortcode2 button button-primary" href="javascript:;"><?php _e( 'Insert shortcode', 'wp-cred' ); ?></a>
		</p>
