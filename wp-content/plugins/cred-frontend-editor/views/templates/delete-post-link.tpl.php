...
function _cred_cred_delete_post_handler(__isFromLink__, __link__, __url__, __result__)
{
    var __ltext__='';
    ...
    {
        var __go__=confirm('<?php echo esc_js(__('Are you sure you want to delete this post?', 'wp-cred')); ?>');
...
<a href='<?php echo $link; ?>' <?php if ($link_atts!==false) echo $link_atts; ?> id='<?php echo $link_id; ?>' target='<?php echo $iframehandle; ?>' onclick='return _cred_cred_delete_post_handler(true, this, false);'><?php echo $text; ?></a>