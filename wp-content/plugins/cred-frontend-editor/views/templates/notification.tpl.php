...
<div id="cred_notification_settings_panel-<?php echo $ii; ?>" class='cred_notification_settings_panel cred_validation_section'>
	...
	<fieldset class="cred-fieldset cred-notification-recipient-fieldset">
		...
		<p>
			<label style="display:block;" class='cred-label'>
				<input data-cred-bind="{ validate: {
                                        required: {
                                            actions: [
                                                {action: 'validationMessage', domRef: '#notification_recipient_required-<?php echo $ii; ?>' },
	...
	<fieldset class="cred-fieldset">
        ...
        <p class="cred-label-holder">
            <label>
				...
				<input type="text" id="credmailsubject<?php echo $ii ?>" style="position:relative;width:95%%;" style='position:relative;' name="_cred[notification][notifications][<?php echo $ii; ?>][mail][subject]" value="<?php echo $notification['mail']['subject']; ?>" />
			</label>
		</p>
	</fieldset>
   ...
   <fieldset class="cred-fieldset">
		...
		<div id="cred_mail_body_placeholders-<?php echo $ii;?>" class="cred-label-holder">
