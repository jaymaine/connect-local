...
<fieldset class="cred-fieldset">
    ...
    <div data-cred-bind="{ action: 'fadeSlide', condition: '_cred[form][action]=message' }">
        ...
        <?php echo CRED_Helper::getRichEditor( 'credformactionmessage', '_cred[form][action_message]', $settings['action_message'], array('teeny'=>true, 'editor_height' => 200) ); ?>
	...
	<?php foreach ($cred_themes as $theme_code=>$theme_name) { ?>
	    <li>
	    	<label class='cred-label'>
	    	    <input type='radio' class='cred-radio-10' name='_cred[form][theme]' value='<?php echo $theme_code; ?>' <?php if ($settings['theme']==$theme_code) echo 'checked="checked"'; ?> />
