...
<div class="wrap">
    ...
    <a class="cred-help-link" title="<?php echo CRED_CRED::$help['add_forms_to_site']['text']; ?>" href="<?php echo CRED_CRED::$help['add_forms_to_site']['link']; ?>" target="_blank" title="<?php echo esc_attr(CRED_CRED::$help['add_forms_to_site']['text']); ?>">
